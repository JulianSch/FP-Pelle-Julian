...
# ## Read in Data ###
temp1, current1 = np.genfromtxt('daten2.txt', unpack=True)  # Messreihe 1 Heizrate 2
temp2, current2 = np.genfromtxt('daten3.txt', unpack=True)  # Messreihe 2 Heizrate 1.5
# temp in celsius
...
# ## Chop off messy Data ##
mc1 = current1[temp1 < -10]  # messy Data 1
mc2 = current2[temp2 < -75]  # messy Data 2
current1 = current1[temp1 > -10]
current2 = current2[temp2 > -75]
ctemp1 = temp1[temp1 > -10]
ctemp2 = temp2[temp2 > -75]
...
plt.plot(temp1, fc1, 'xb', label="Messdaten Heizrate = 2,5")
...
# plt.vlines([-41.8, -0.4], -11, 45, colors='r', linestyle='--', label='Auswertungsbereich')
...
print(len(ut1))
print(len(uc1))
print('minimum', min(uc1))
uc1[1] = uc1[1]+0.00001
print(min(uc1[ut1 > -40]))
print('ut1= ', ut1)
print('uc1= ', uc1)
print('array?',  len(uc1[ut1 > -20]))
print('min ut2 Länge', len(uc2[ut2 > -40]))
...
current1 = current1[(ctemp1 > ut1[uc1 == min(uc1)]) & (ctemp1 < ut1[uc1 == min(uc1[ut1 > -40])])]  # -20
current2 = current2[(ctemp2 > ut2[uc2 == min(uc2)]) & (ctemp2 < ut2[uc2 == min(uc2[ut2 > -40])])]
print('länge temp2', len(ctemp2))
print()
